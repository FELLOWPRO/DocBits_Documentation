...
* [Workflow](administration-and-setup/workflow/README.md)
  ...
  * [Padrões de Workflow](administration-and-setup/workflow/patterns/README.md)
    * [Padrão de Integração de API](administration-and-setup/workflow/patterns/api-integration-pattern.md)
    * [Padrão de Gestão de Tarefas](administration-and-setup/workflow/patterns/task-management-pattern.md)
    * [Padrão de Correspondência de Encomendas (PO Matching)](administration-and-setup/workflow/patterns/po-matching-pattern.md)
    * [Padrão de Lógica de Decisão](administration-and-setup/workflow/patterns/decision-logic-pattern.md)
    * [Padrão de Transformação de Dados](administration-and-setup/workflow/patterns/data-transformation-pattern.md)
