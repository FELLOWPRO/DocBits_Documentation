...
* [Workflow](administration-and-setup/workflow/README.md)
  ...
  * [Modèles de workflow](administration-and-setup/workflow/patterns/README.md)
    * [Modèle d'intégration d'API](administration-and-setup/workflow/patterns/api-integration-pattern.md)
    * [Modèle de gestion des tâches](administration-and-setup/workflow/patterns/task-management-pattern.md)
    * [Modèle de rapprochement de commandes (PO Matching)](administration-and-setup/workflow/patterns/po-matching-pattern.md)
    * [Modèle de logique de décision](administration-and-setup/workflow/patterns/decision-logic-pattern.md)
    * [Modèle de transformation des données](administration-and-setup/workflow/patterns/data-transformation-pattern.md)
