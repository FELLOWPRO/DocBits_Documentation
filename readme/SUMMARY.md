...
* [FAQ](overview-and-basics/faq/README.md)
  ...
  * [Dokumentenverarbeitung](overview-and-basics/faq/document-processing/README.md)
    ...
    * [Welcher Extraktionspfad wurde verwendet?](overview-and-basics/faq/document-processing/which-extraction-path-was-used.md)
...
* [Einstellungen](admin-section/settings/README.md)
  ...
  * [Dokumentenverarbeitung](admin-section/settings/document-processing/README.md)
    ...
    * [Export](administration-and-setup/settings/document-processing/export.md)
      * [Positionen im Export](administration-and-setup/settings/document-processing/line-items-in-export.md)
...
* [Importing Master Data](infor-integration-and-configuration/importing-customer-master-data/README.md)
  ...
  * [Import über die API](infor-integration-and-configuration/importing-customer-master-data/importing-via-the-api/README.md)
    * [Lieferanten importieren (Supplier BOD)](infor-integration-and-configuration/importing-customer-master-data/importing-via-the-api/supplier-bod.md)
    * [Bestellungen importieren (Purchase Order BOD)](infor-integration-and-configuration/importing-customer-master-data/importing-via-the-api/purchase-order-bod.md)
    * [Wareneingänge importieren (Receive Delivery BOD)](infor-integration-and-configuration/importing-customer-master-data/importing-via-the-api/receive-delivery-bod.md)
    * [Stammdaten aus XML importieren](infor-integration-and-configuration/importing-customer-master-data/importing-via-the-api/master-data-xml.md)
