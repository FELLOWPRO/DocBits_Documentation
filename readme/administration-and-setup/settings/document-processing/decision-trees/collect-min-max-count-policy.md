...
1. Se è selezionata l'opzione **Raccogliere (Min)**, il risultato restituirà il **minimo** dei **Return Values** per le regole corrispondenti.
   ...
   * Poiché viene applicato il criterio **Raccogliere (Min)**, il risultato sarà il **valore minimo**, ovvero **3**.
   * **Risultato**: **3**
2. Se è selezionata l'opzione **Raccogliere (max)**, il risultato restituirà il **massimo** dei **Return Values** per le regole corrispondenti.
   * Per la stessa valutazione di cui sopra, il risultato sarà:
   * **Risultato**: **5**
3. Se è selezionata l'opzione **Raccogliere (conteggio)**, il risultato conterà il **numero di regole corrispondenti**.
   * Per la stessa valutazione di cui sopra, il risultato sarà:
