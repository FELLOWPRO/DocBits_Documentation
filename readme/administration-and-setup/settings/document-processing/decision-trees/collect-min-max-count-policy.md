...
1. Wenn die Option **Sammeln (Min)** ausgewählt ist, gibt das Ergebnis das **Minimum** der **Rückgabewerte** der zutreffenden Regeln zurück.
   ...
   * Da die Policy **Sammeln (Min)** angewendet wird, ist das Ergebnis der **Minimalwert**, also **3**.
   * **Ergebnis**: **3**
2. Wenn die Option **Sammeln (Max)** ausgewählt ist, gibt das Ergebnis das **Maximum** der **Rückgabewerte** der zutreffenden Regeln zurück.
   * Bei derselben Auswertung wie oben lautet das Ergebnis:
   * **Ergebnis**: **5**
3. Wenn die Option **Sammeln (Zählen)** ausgewählt ist, zählt das Ergebnis die **Anzahl der zutreffenden Regeln**.
   * Bei derselben Auswertung wie oben lautet das Ergebnis:
