...
1. Si l'option **Collecte (Min)** est sélectionnée, le résultat renverra le **minimum** des **Return Values** des règles correspondantes.
   ...
   * Étant donné que la politique **Collecte (Min)** est appliquée, le résultat sera la **valeur minimale**, soit **3**.
   * **Résultat** : **3**
2. Si l'option **Collecte (Max)** est sélectionnée, le résultat renverra le **maximum** des **Return Values** des règles correspondantes.
   * Pour la même évaluation que ci-dessus, le résultat sera :
   * **Résultat** : **5**
3. Si l'option **Collecter (compter)** est sélectionnée, le résultat comptera le **nombre de règles correspondantes**.
   * Pour la même évaluation que ci-dessus, le résultat sera :
