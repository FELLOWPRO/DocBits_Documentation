...
{% hint style="info" %}
**Relacionado:** Para ler manualmente um valor de código de barras/QR durante a validação de um documento e atribuí-lo a um campo, consulte [Atribuição por código de barras](../barcode-assignment.md).
{% endhint %}
