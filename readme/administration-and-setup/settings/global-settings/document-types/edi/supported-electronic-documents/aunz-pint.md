...
<figure><img src="aunz-pint-preview.png" alt="AUNZ PINT invoice preview in DocBits"><figcaption><p>Default DocBits preview for an AUNZ PINT invoice</p></figcaption></figure>
...
| `VAT` | *(calculated from tax amount)* | GST amount per line |
...
|---------|-----------|--------------------------|
| `urn:peppol.org:pint:billing-1@aunz` | STRING_CONTAINS | PINT A-NZ (Invoice) |
| `urn:peppol.org:pint:selfbilling-1@aunz` | STRING_CONTAINS | PINT A-NZ (Self-Billing Invoice) |
