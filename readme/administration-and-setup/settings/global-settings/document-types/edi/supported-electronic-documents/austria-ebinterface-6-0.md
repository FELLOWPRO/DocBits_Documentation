...
ebInterface 6.0 a introduit l'alignement sur la norme européenne EN 16931 tout en maintenant la compatibilité ascendante avec les exigences spécifiques à l'Autriche. Il prend en charge la représentation structurée des données de facturation, notamment les lignes de détail, les informations fiscales et les données de paiement. L'espace de noms est `http://www.ebinterface.at/schema/6p0/`.
...
DocBits détecte les documents AUSTRIA EBINTERFACE 6.0 par la chaîne d'espace de noms :
