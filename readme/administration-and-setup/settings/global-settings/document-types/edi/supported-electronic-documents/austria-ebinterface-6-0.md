---
description: DocBits'te AUSTRIA EBINTERFACE 6.0 elektronik belge desteği
---
...
| **Biçim** | XML |
| **Standart** | ebInterface 6.0 |
| **Locale** | `de_AT` |

ebInterface 6.0, Avusturya'ya özgü gereksinimlerle geriye dönük uyumluluğu korurken Avrupa standardı EN 16931 ile uyumlu hale getirmeyi tanıttı. Kalem detayları, vergi bilgileri ve ödeme bilgileri dahil olmak üzere fatura verilerinin yapılandırılmış gösterimini destekler. Ad alanı `http://www.ebinterface.at/schema/6p0/` şeklindedir.
...
<figure><img src="austria-ebinterface-preview.png" alt="DocBits'te Austria ebInterface 6.0 fatura önizlemesi"><figcaption><p>AUSTRIA EBINTERFACE 6.0 faturası için varsayılan DocBits önizlemesi</p></figcaption></figure>
...
DocBits, AUSTRIA EBINTERFACE 6.0 belgelerini ad alanı dizesine göre algılar:
