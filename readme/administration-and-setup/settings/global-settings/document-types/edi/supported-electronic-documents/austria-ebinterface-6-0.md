---
description: Ondersteuning voor elektronisch document AUSTRIA EBINTERFACE 6.0 in DocBits
---
...
| **Formaat** | XML |
| **Standaard** | ebInterface 6.0 |
| **Locale** | `de_AT` |

ebInterface 6.0 introduceerde afstemming met de Europese norm EN 16931 terwijl backward-compatibiliteit met Oostenrijkse specifieke vereisten behouden bleef. Het ondersteunt de gestructureerde weergave van factuurgegevens inclusief regelitems, belastingdetails en betalingsinformatie. De namespace is `http://www.ebinterface.at/schema/6p0/`.
...
<figure><img src="austria-ebinterface-preview.png" alt="Austria ebInterface 6.0 factuurvoorbeeld in DocBits"><figcaption><p>Standaard DocBits-voorbeeld voor een AUSTRIA EBINTERFACE 6.0-factuur</p></figcaption></figure>
...
DocBits detecteert AUSTRIA EBINTERFACE 6.0-documenten aan de hand van de namespace-string:
