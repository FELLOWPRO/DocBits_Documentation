---
description: Suporte para documento eletrônico AUSTRIA EBINTERFACE 6.0 no DocBits
---
...
| **Formato** | XML |
| **Padrão** | ebInterface 6.0 |
| **Locale** | `de_AT` |

O ebInterface 6.0 introduziu o alinhamento com o padrão europeu EN 16931, mantendo a compatibilidade retroativa com os requisitos específicos da Áustria. Suporta a representação estruturada de dados de faturação, incluindo itens de linha, detalhes fiscais e informações de pagamento. O namespace é `http://www.ebinterface.at/schema/6p0/`.
...
<figure><img src="austria-ebinterface-preview.png" alt="Pré-visualização da fatura Austria ebInterface 6.0 no DocBits"><figcaption><p>Pré-visualização padrão do DocBits para uma fatura AUSTRIA EBINTERFACE 6.0</p></figcaption></figure>
...
O DocBits detecta documentos AUSTRIA EBINTERFACE 6.0 através da string de namespace:
