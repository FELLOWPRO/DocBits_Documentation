---
description: Soporte de documentos electrónicos AUSTRIA EBINTERFACE 6.1 en DocBits
---
...
| **Formato** | XML |
| **Estándar** | ebInterface 6.1 |
| **Configuración regional** | `de_AT` |

ebInterface 6.1 es la última versión del estándar austriaco de facturación electrónica. Incluye reglas de validación actualizadas, mejor soporte para notas de crédito y compatibilidad mejorada con la red Peppol para facturación transfronteriza. El espacio de nombres es `http://www.ebinterface.at/schema/6p1/`.
...
<figure><img src="austria-ebinterface-preview.png" alt="Vista previa de factura Austria ebInterface 6.1 en DocBits"><figcaption><p>Vista previa predeterminada de DocBits para una factura AUSTRIA EBINTERFACE 6.1</p></figcaption></figure>
...
DocBits detecta documentos AUSTRIA EBINTERFACE 6.1 mediante la cadena de espacio de nombres:
