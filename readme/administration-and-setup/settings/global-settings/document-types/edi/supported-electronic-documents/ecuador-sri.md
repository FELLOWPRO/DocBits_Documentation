---
description: >-
  Ecuador SRI (Factura Electrónica, SRI 1.0.0 – 2.1.0) electronic document
  support in DocBits
---
...
<figure><img src="../../../../../../.gitbook/assets/ecuador-sri-preview.png" alt="Ecuador SRI Factura preview in DocBits"><figcaption><p>Default DocBits preview for an Ecuador SRI Factura Electrónica (version 2.1.0)</p></figcaption></figure>
...
| `supplier_tax_id`  | `infoTributaria/ruc`                                | RUC (same as supplier\_id)                     |
