---
description: Podrška za PINT A-NZ elektronske dokumente u DocBits
---
...
PINT A-NZ (Peppol International Model for Australia-New Zealand) je lokalizovana Peppol specifikacija fakturisanja za region Australije/Novog Zelanda. Proširuje globalni PINT model sa A-NZ specifičnim poslovnim pravilima, poreskim kategorijama (GST) i šemama identifikacije (ABN, NZBN). Ovo je tehnička referentna stranica sa kompletnim mapiranjem polja.
...
<figure><img src="aunz-pint-preview.png" alt="Pregled PINT A-NZ fakture u DocBits"><figcaption><p>Podrazumevani DocBits pregled za PINT A-NZ fakturu</p></figcaption></figure>
...
Za self-billing dokumente, obrazac je:

```
urn:peppol.org:pint:selfbilling-1@aunz
```

Oba se klasifikuju pod elektronski tip dokumenta `PINT A-NZ`.

## Takođe pogledajte

- [AUNZ PINT](aunz-pint.md) — Pregled i A-NZ specifične funkcije
- [AUNZ PINT Self-Billing](aunz-pint-self-billing.md) — Self-billing varijanta
