...
### [Функције претраге Fulltext и векторске претраге](fulltext-search-functions.md)

Претражујте архиве докумената, пронађите сличне документе и упитајте ERP главне податке — `fulltext_search()`, `vector_search()`, `fulltext_search_erp()`, `fulltext_suggestions()`. **Доступно од верзије 11.48.0**, захтева `OPENSEARCH_ENABLED` лиценцу.
...
| **Претрага** | `fulltext_search`, `vector_search`, `fulltext_search_erp`, `fulltext_suggestions` |
