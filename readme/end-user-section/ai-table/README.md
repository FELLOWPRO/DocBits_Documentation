...
Welche KI-Stufe die Tabelle liest (Fast, Full, Nexus), wird pro Organisation festgelegt und kann pro Lieferant unter *Weitere Einstellungen* im Validierungsbildschirm überschrieben werden, siehe [Lieferantenspezifisches KI-Modell](../../end-user-and-partner-section/end-user-section/validation-screen/supplier-specific-ai-model-for-field-and-table-extraction.md).

## Die KI-Tabelle erneut extrahieren

Verwenden Sie dies, wenn Zeilen fehlen oder eine Spalte verschoben ist und die KI es erneut versuchen soll, zum Beispiel nach dem Hinzufügen eines [Tags](../../end-user-and-partner-section/end-user-section/ai-table/ai-table-tags.md):

1. Fügen Sie im Feld unter der Tabelle [Tags](../../end-user-and-partner-section/end-user-section/ai-table/ai-table-tags.md) hinzu oder ändern Sie sie und klicken Sie auf **Anwenden**. Die KI baut die Tabelle für dieses Dokument mit Ihren Tags und Spaltenänderungen neu auf; für den Lieferanten wird noch nichts gespeichert. Hat das Dokument mit Bestellungen abgeglichene Positionen, warnt DocBits, dass die Zuordnungen durch den Neuaufbau entfernt werden.
