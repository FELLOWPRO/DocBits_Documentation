...
_What changes in the DocBits production hotfix on 15 September 2026, covering
everything since the 1 September release. Each service lists the version being
...
- Discount due dates are calculated on import, not only when someone saves the
  document. The Discount Due Date column on the dashboard stayed blank for
  imported documents.
