...
* Atualizar Lista: Usado para atualizar o painel sem precisar recarregar a aba do navegador.
* Configurações Avançadas: Mais informações sobre este tópico estão disponíveis mais abaixo nesta página.
* Análises: Fornece mais informações sobre os documentos que você enviou ao DocBits.
* Upload: Mais informações sobre este tópico na próxima seção.
